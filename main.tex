...
\subsection{Widok tablicy oraz zadań}
...
\end{figure}
\begin{enumerate}
  \item Informacje odnośnie tablice. Od lewej: ikona, nazwa tablicy, menu z opcjami.
...
\newpage
\subsection{Widok czatu wiadomości tekstowych}
\subsubsection{Widok przykładowego czatu z wylistowanymi wiadomościami}
\begin{figure}[H]
  \begin{center}
